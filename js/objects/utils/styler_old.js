...
const cssStyler = (styleObj, propertyName, propertyValue) => {
    ...
    case "background-color":
        if(propertyValue == "default"){
            ...
            delete styleObj['--skin-background-color'];
            console.log("deleted the background color!");
            console.log(styleObj);
        } else {
            _setOrNot(styleObj, "--skin-background-color",  _colorToRGBA(styleObj["backgroundColor"], propertyValue));
        }
        break;
    ...
    case "background-transparency":
        ...
        // break;
        console.log("setting background transparency:");
        console.log(propertyValue);
        if(propertyValue == "default"){
            delete styleObj['--skin-background-opacity'];
        } else {
            _setOrNot(styleObj, '--skin-background-opacity', propertyValue);
        }
        break;
